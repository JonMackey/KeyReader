/*
*	TFT_ILI9488P.h, Copyright Jonathan Mackey 2025
...
*
*/
#ifndef TFT_ILI9488P_h
#define TFT_ILI9488P_h
...
class TFT_ILI9488P : public DisplayController
{
public:
							TFT_ILI9488P(
								pin_t					inResetPin,	
...
protected:
	...
	uint8_t					ReadCmdReg(
								uint8_t 				inCmd) const;
	inline uint16_t			ReadData(void) const
							{
								return(*FMC_DataAddr);
							}
